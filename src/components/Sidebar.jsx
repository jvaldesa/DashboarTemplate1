...
import { RiArrowRightSLine, RiBarChart2Line, RiCalendarTodoLine, RiCloseLine, RiCustomerService2Line, RiEarthLine, RiLogoutCircleLine, RiMenu3Line, RiMessage3Line } from 'react-icons/ri'
  ...
  return (
    <>
      ...
      <button onClick={()=> setShowMenu(!showMenu)} className='xl:hidden fixed bottom-4 right-4 bg-primary text-black p-3 rounded-full z-50'>
        {showMenu? <RiCloseLine className='' /> : <RiMenu3Line className='' /> }
