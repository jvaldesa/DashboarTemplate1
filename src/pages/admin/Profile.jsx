    ...
    <>
        ...
        <form className="mb-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-y-4 justify-between">
            <div>
              ...
              <p className="text-gray-500 text-sm">jvaldes_a@hotmail.com</p>
            </div>
            <div>
      ...
      <div className='bg-secondary-100 p-8 rounded-xl mb-8'>
        ...
        <form className="mb-8" >
          ...
          {/* // l-3 Payments */}
          <div className='flex items-center gap-4'>
            <input className='accent-primary' type="checkbox" id='id1' />
            <div className='flex flex-col gap-y-1'>
              <label className='text-gray-100' htmlFor="id1">
                  Successful Payments
              </label>
              <p className='text-gray-500 text-sm'>
          ...
          {/* // l-3 Payouts */}
          <div className='flex items-center gap-4'>
            <input className='accent-primary' type="checkbox" id='id2' />
            <div className='flex flex-col gap-y-1'>
              <label className='text-gray-100' htmlFor="id2">
                Payouts
              </label>
              <p className='text-gray-500 text-sm'>
          ...
          {/* // l-3 Customer Payment Dispute */}
          <div className='flex items-center gap-4'>
            <input className='accent-primary' type="checkbox" id='id3' />
            <div className='flex flex-col gap-y-1'>
              <label className='text-gray-100' htmlFor="id3">
