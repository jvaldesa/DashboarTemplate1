...
export const Tickets = () => {
  return (
    <div>
      ...
      {/* // l-1 Portada */}
      <div className="bg-secondary-100 p-8 rounded-t-lg grid grid-cols-1 md:grid-cols-2 items-center">
        {/* // l-2 Form */}
        <div className="p-8">
      ...
      {/* // l-1 Tabs */}
      <Tab.Group>
        <div className='bg-secondary-100 p-8 rounded-b-lg'>
          {/* // l-2 Encabezados Tabs */}
          <Tab.List className="flex flex-col md:flex-row md:items-center md:justify-between gap-x-2 gap-y-6 bg-secondary-900/50 py-3 px-4 rounded-lg">
            <div className='flex flex-col md:flex-row md:items-center gap-2'>
              <Tab className="py-2 px-4 rounded-lg hover:bg-secondary-900 hover:text-green-100 transition-colors outline-none ui-selected:bg-secondary-900 ui-selected:text-gray-100">
                Overview
              </Tab>
              <Tab className="py-2 px-4 rounded-lg hover:bg-secondary-900 hover:text-green-100 transition-colors outline-none ui-selected:bg-secondary-900 ui-selected:text-gray-100">
                Tickets
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
              ...
              <div className=' bg-secondary-100 p-8 rounded-lg'>
                ...
                <div className='flex items-center justify-between mb-8'>
                  <h1 className='text-white text-xl md:text-2xl'>Popular Tickets</h1>
                ...
                <div>
                  {/* // l-7 Accordion 1 */}
                  <Disclosure>
                    <Disclosure.Button className="py-2 text-sm sm:text-lg flex items-center justify-between gap-4">
                      ...
                      <span className='hidden lg:block bg-secondary-900 text-white text-sm py-0.5 px-2 rounded-lg'>React</span>
                    </Disclosure.Button>
                    <Transition
                    ...
                    >
                      ...
                      By Keenthemes to save tons and more to time money projects are listed and outstanding <Link to="/" className='text-primary'>Learn more</Link>
                      </Disclosure.Panel>
                    </Transition>
                  </Disclosure>
                  {/* // l-7 Accordion 2 */}
                  <Disclosure>
                    <Disclosure.Button className="py-2 text-sm sm:text-lg flex items-center justify-between gap-4">
                      ...
                      <span className='hidden lg:block bg-secondary-900 text-white text-sm py-0.5 px-2 rounded-lg'>Laravel</span>
                    </Disclosure.Button>
                    <Transition
                      enter="transition duration-100 ease-out"
                      enterFrom="transform scale-95 opacity-0"
                  ...
                  <Disclosure>
                    <Disclosure.Button className="py-2 text-sm sm:text-lg flex items-center justify-between gap-4">
                      ...
                      <span className='hidden lg:block bg-secondary-900 text-white text-sm py-0.5 px-2 rounded-lg'>Next JS 13</span>
                    </Disclosure.Button>
                    <Transition
                      enter="transition duration-100 ease-out"
                      enterFrom="transform scale-95 opacity-0"
                  ...
                  <Disclosure>
                    <Disclosure.Button className="py-2 text-sm sm:text-lg flex items-center justify-between gap-4">
                      ...
                      <span className='hidden lg:block bg-secondary-900 text-white text-sm py-0.5 px-2 rounded-lg'>Vue JS</span>
                    </Disclosure.Button>
                    <Transition
                      enter="transition duration-100 ease-out"
                      enterFrom="transform scale-95 opacity-0"
                ...
                <div className='p-8 flex justify-center'>
                  <nav className='flex items-center gap-2'>
                    ...
                    <div className='flex items-center'>
                      <button className='p-2 px-4 hover:bg-secondary-900 rounded-lg transition-colors hover:text-gray-100'>
                        1
                      </button>
                      <button className='p-2 px-4 bg-secondary-900 rounded-lg transition-colors hover:text-gray-100'>
                        2
                      </button>
                      <button className='p-2 px-4 hover:bg-secondary-900 rounded-lg transition-colors hover:text-gray-100'>
                        3
                  ...
                  <div className='border-b border-dashed border-gray-600 p-2'>
                    <Disclosure>
                      <Disclosure.Button className="py-2 text-sm sm:text-lg flex items-center justify-between gap-4">
                        <RiArrowRightSLine className="text-xl ui-open:rotate-90 ui-open:text-primary ui-open:transform transition-all" />
                        What admin theme does?
                        <span className='hidden md:block bg-secondary-900 text-white text-sm py-0.5 px-2 rounded-lg'>React</span>
                      </Disclosure.Button>
                      <Transition
                        enter="transition duration-100 ease-out"
                        enterFrom="transform scale-95 opacity-0"
